...
- 보험 챗봇: `POST /api/insurance/chat` (JWT) · CLI는 `scripts/ins_chatbot.py` → [docs/ins-chatbot.md](./docs/ins-chatbot.md), 인수인계 [docs/ins-chatbot-frontend-handoff.md](./docs/ins-chatbot-frontend-handoff.md)  
