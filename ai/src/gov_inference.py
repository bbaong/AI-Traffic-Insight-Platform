"""GovGuard AI v1.0.4 추론 — share×시전체 + last×2 캡 건수 (+EB 중대 보조)."""
...
MODEL_PATH = MODEL_DIR / "gov_model_v1.0.4.pkl"
SCRIPT_PATH = Path(__file__).resolve().parent.parent / "scripts" / "gov_v1_0_4.py"
