...
"""
GovGuard AI v1.0.3
지자체용 — 지도·대응 인력 중심 (어디 사고가 많은가)

v1.0.2 대비:
- 점유율 학습에 사고건수 sample_weight
- next_사고건수 직접 회귀 (지도 메인 지표)
- 추론 기본 정렬: 예상 건수 내림차순 (중대율은 보조 레이어)
- 평가: 가중 MAE/R², 건수 MAE, Top-3 구 일치

v1.0.2 기능 유지: EB 중대/경중, 반기 보조
"""
