# -*- coding: utf-8 -*-
"""
InsureGuard AI v1.0.4 (보관)

현재 서빙은 scripts/ins_v1_0_5.py / models/ins_model_v1.0.5.pkl 입니다.
이 파일의 ROOT는 scripts/archive 기준 ai 루트(parents[2])입니다.
"""
...
v1.0.3 대비: 군위 2016.1~2023.6(편입 전) 사고 포함 재학습. 타깃 산식은 동일.
