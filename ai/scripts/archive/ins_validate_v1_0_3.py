...
사용:
  python scripts/archive/validate_ins_v1_0_3.py
"""
...
OUT_JSON = ROOT / "docs" / "archive" / "validation_v1_0_3_results.json"
OUT_MD = ROOT / "docs" / "archive" / "validation_v1_0_3.md"
TEST_YEARS = {2024, 2025}  # A/B time split: 이 연도들을 test


def _load_ins():
    path = ROOT / "scripts" / "archive" / "ins_v1_0_3.py"
